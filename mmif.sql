...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Agu 2020 pada 15.39
...
INSERT INTO `mahasiswa` (`No.`, `NIM`, `admin`, `panitia`, `nama`, `password`, `email_sso`, `ketude`, `ketum`, `memilih`, `registrasi`, `verif`, `login`, `logout`, `submit_memilih`, `submit_tdkMemilih`) VALUES
...
(327, 'D121191050', '', '', 'Rahma', '$2y$10$EbSe.akOjkrTwOsIWkbrLe/lhGCh9dMVZv.AlkOvt/bbk/O9WyyZO', 'rahmas19d@student.unhas.ac.id', '', '', '', '', 'verif', '', '', '', ''),
(328, 'D121191051', '', '', 'Rein', '$2y$10$ow.0U6A40IC5bzeTBceUDOdK/J3Kg/GPx5vloMYSwqbWNN484o5Ra', 'soplantilarw19d@student.unhas.ac.id', '', '', '', '', 'verif', '', '', '', ''),
(329, 'D121191052', '', '', 'Juan', '$2y$10$k4VlxBKi201JxKiwoaQzy.QuIB80.PhweFwvK9NNmneZDUqzgcbz.', 'aljjd19d@student.unhas.ac.id', '', '', '', '', 'verif', '', '', '', ''),
...
CREATE TABLE `password` (
  ...
  `NIM` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `jam_password` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
